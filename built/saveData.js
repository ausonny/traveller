class saveGameData {
    constructor(name) {
        ...
        this.tier1Feats.push(new achievement(2, 'TierNoPresidents1', 'Complete Tier 1 with no Presidents', 1, 1));
        this.tier1Feats.push(new achievement(3, 'TierChallenge1', 'Complete Tier 1 with a challenge active', 1, 1));
        this.tier2Feats = [];
        this.tier2Feats.push(new achievement(1, 'CompleteTier1', 'Complete Tier 1', 1, 2));
        this.tier2Feats.push(new achievement(2, 'TierNoPresidents1', 'Complete Tier 1 with no Presidents', 1, 2));
        this.tier2Feats.push(new achievement(3, 'TierChallenge1', 'Complete Tier 1 with a challenge active', 1, 2));
    }
}
